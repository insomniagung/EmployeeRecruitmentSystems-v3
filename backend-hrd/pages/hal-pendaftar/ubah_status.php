...
<head>
  ...
  <title>Update Status Penerimaan</title>
  <!-- plugins:css -->
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                ?>
                  ...
                  <form class="forms-sample" method="POST" action="ubah_status_act.php">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="status_seleksi" class="form-control">
                                    ...
                                    <?php } else if($data['status_seleksi'] == 'Lolos'){ ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="tgl_wcr" value="<?=$data['tgl_wcr'];?>">
                    </div>

                    <div class="form-group">
                      <label>Hasil Wawancara</label>
                      <select name="status_wcr" class="form-control">
                                    <?php 
                                    if ($data['status_wcr'] == 'Pending'){
                                    ?>
                                    <option value="Pending" selected>Pending</option>
                                    <option value="Lolos & Diterima">Lolos & Diterima</option>
                                    <option value="Tidak Lolos">Tidak Lolos</option>

                                    <?php } else if($data['status_wcr'] == 'Lolos & Diterima'){ ?>
                                    <option value="Pending">Pending</option>
                                    <option value="Lolos & Diterima" selected>Lolos & Diterima</option>
                                    <option value="Tidak Lolos">Tidak Lolos</option>
                ...
                <?php   } ?>
                    ...
                    <a class="btn btn-light" href="pendaftar.php">Cancel</a>                
                  </form>
