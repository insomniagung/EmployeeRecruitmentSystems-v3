              ...
              ?>
                  ...
                  <div class="table-responsive">  
                    ...
                    <tr>
                      ...
                      $queryData = mysqli_query($koneksi,"SELECT * FROM job");
                      $pagination = 5; 
                      $halaman = isset($_GET['halaman'])?(int)$_GET['halaman'] : 1;
                      $halaman_awal = ($halaman > 1) ? ($halaman * $pagination) - $pagination : 0;
                      $previous = $halaman - 1;
                      $saatIni = $previous - 1;
                      $next = $halaman + 1;
                      $jumlah_data = mysqli_num_rows($queryData);
                      $total_halaman = ceil($jumlah_data / $pagination);

                      $data_job = mysqli_query($koneksi,"SELECT * FROM job LIMIT $halaman_awal, $pagination");
                      ...
                      if(isset($_GET['pencarian'])){
                          ...
                          $cariData = mysqli_query($koneksi,"SELECT * FROM job 
                          WHERE jobname LIKE '%".$cari."%' LIMIT $pagination"); //cari cuma 1 data

                        // $cekData = mysqli_num_rows($cariData);
                        // var_dump($cekData);   
                    ...
                    <?php $cekTotal = mysqli_num_rows($cariData);
                          // var_dump($cekTotal);
                    ?>
                    ...
                    <nav>
                      ...
                      <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item">
                          <a class="page-link" 
                          <?php 
                          if($halaman > 1){ echo "href='?halaman=$previous'"; }
                          ?>
                          >Previous</a>
                        </li>
                        ...
                        <?php } ?>
                            ...
                            <?php if($jumlah_data > 5 && $cekTotal >= 5 ) { ?>
